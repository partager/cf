...
(function ($) {
        ...
        , methods: {
            init: function (options) {
                ...
                $(uniqueForms).bind("submit.validationSubmit", function (e) {
                    ...
                    var $allControlGroups = $form.find(".mb-3");
                ...
                return this.each(function () {
                    var $this = $(this)
                        , $controlGroup = $this.parents(".mb-3").first()
        ...
        , validatorTypes: {
            ...
            , match: {
                ...
                , init: function ($this, name) {
                    ...
                    else if (($label = $element.parents(".mb-3").first().find("label")).length) {
    ...
    var getValue = function ($this) {
        ...
        if (type === "checkbox") {
            ...
            var checkboxParent = $this.parents("form").first() || $this.parents(".mb-3").first();
            if (checkboxParent) {
            ...
            var radioParent = $this.parents("form").first() || $this.parents(".mb-3").first();
            if (radioParent) {
