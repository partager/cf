...
<head>
	...
	<base href="">
	<title>Editor-(ShopFunnels)</title>
...
<body>
	...
	<div id="vvveb-builder">
			...
			<!-- <div id="filemanager"> 
							<div class="header">
								<a href="#" class="text-secondary">Pages</a>
									...
									<div class="btn-group responsive-btns me-4 float-right" role="group">
				...
				<div class="header">
					<ul class="nav nav-tabs" id="elements-tabs" role="tablist">
						<li class="nav-item component-tab">
							<a class="nav-link active" id="components-tab" data-bs-toggle="tab" href="#components" role="tab" aria-controls="components" aria-selected="true"><i class="la la-lg la-cube"></i>
								<div><small>Components</small></div>
							</a>
						</li>
						<li class="nav-item blocks-tab">
							<a class="nav-link" id="blocks-tab" data-bs-toggle="tab" href="#blocks" role="tab" aria-controls="blocks" aria-selected="false"><i class="la la-lg la-image"></i>
								<div><small>Blocks</small></div>
							</a>
						</li>
						<li class="nav-item component-properties-tab" style="display:none">
							<a class="nav-link" id="properties-tab" data-bs-toggle="tab" href="#properties" role="tab" aria-controls="blocks" aria-selected="false"><i class="la la-lg la-cog"></i>
									...
									<div class="component-properties">
										<ul class="nav nav-tabs nav-fill" id="properties-tabs" role="tablist">
											...
											<li class="nav-item style-tab">
												<a class="nav-link" data-bs-toggle="tab" href="#style-left-panel-tab" role="tab" aria-controls="blocks" aria-selected="false">
													<i class="la la-lg la-image"></i>
													<div><span>Style</span></div>
												</a>
											</li>
											<li class="nav-item advanced-tab">
												<a class="nav-link" data-bs-toggle="tab" href="#advanced-left-panel-tab" role="tab" aria-controls="blocks" aria-selected="false">
					...
					<div id="add-section-box" class="drag-elements">
						...
						<div class="header">
							<ul class="nav nav-tabs" id="box-elements-tabs" role="tablist">
								...
								<li class="nav-item blocks-tab">
									<a class="nav-link" id="box-blocks-tab" data-bs-toggle="tab" href="#box-blocks" role="tab" aria-controls="blocks" aria-selected="false"><i class="la la-lg la-image"></i>
										<div><small>Blocks</small></div>
									</a>
								</li>
								<li class="nav-item component-properties-tab" style="display:none">
									<a class="nav-link" id="box-properties-tab" data-bs-toggle="tab" href="#box-properties" role="tab" aria-controls="blocks" aria-selected="false"><i class="la la-lg la-cog"></i>
										<div><small>Properties</small></div>
									</a>
								</li>
							</ul>
							...
							<div class="section-box-actions">
								...
								<div class="small mt-1 me-3 float-right">
		...
		<script id="vvveb-input-radiobuttoninput" type="text/html">
			<div class="btn-group btn-group-toggle  {%if (extraclass) { %}{%=extraclass%}{% } %} clearfix" data-bs-toggle="buttons">
		...
		<script id="vvveb-input-grid" type="text/html">
			<div class="row">
				<div class="mb-1 col-12">
					...
					<label>Flexbox</label>
					<select class="form-select custom-select" name="col">
				...
				<div class="col-6">
					...
					<select class="form-select custom-select" name="col-xs">
				...
				<div class="col-6">
					<label>Small</label>
					<select class="form-select custom-select" name="col-sm">
				...
				<div class="col-6">
					<label>Medium</label>
					<select class="form-select custom-select" name="col-md">
				...
				<div class="col-6 mb-1">
					<label>Large</label>
					<select class="form-select custom-select" name="col-lg">
		...
		<script id="vvveb-input-cssunitinput" type="text/html">
			<div class="input-group" id="cssunit-{%=key%}">
				...
				<div class="input-group-append">
					<select class="form-select custom-select small-arrow" name="unit">
		...
		<script id="vvveb-property" type="text/html">
			<div class="mb-3 {% if (typeof col !== 'undefined' && col != false) { %} col-sm-{%=col%} d-inline-block {% } else { %}row{% } %}" data-key="{%=key%}" {% if (typeof group !== 'undefined' && group != null) { %}data-group="{%=group%}" {% } %}>
			...
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content">
					...
					<div class="modal-footer">
						<button type="button" class="btn btn-secondary btn-lg" data-bs-dismiss="modal"><i class="la la-close"></i> Close</button>
					</div>
				</div>
			</div>
		</div>
				...
				<form>
					...
					<div class="modal-content">
						...
						<div class="modal-body text">
							<div class="mb-3 row" data-key="type">
								...
								<div class="col-sm-9 input">
									<div>
										<select class="form-select custom-select" name="startTemplateUrl">
						...
						<div class="modal-footer">
							...
							<button class="btn btn-secondary btn-lg" type="reset" data-bs-dismiss="modal"><i class="la la-close"></i> Cancel</button>
						</div>
					</div>
