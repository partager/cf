...
Vvveb.Components.extend("_base", "html/selectinput", {
  ...
  html: '<div class="mb-3"><label>Choose an option </label><select class="form-select"><option value="value1">Text 1</option><option value="value2">Text 2</option><option value="value3">Text 3</option></select></div>',
...
//   // nodes: ["iframe"],
//   name: t("iframe"),
//   attribute: `data-iframe-selector`,
//   image: "icons/jumbotron.svg",
//   html: `<iframe data-iframe-selector="1" src="https://arvind1.jeetforlife.in/cloudfunnels/home/" height="200" width="300"></iframe>`,
//   properties: [       
//       {
//           name: t("Source"),
//           key: "src",
...
//       },
//       {
//         name: t("Custom Attribute"),
//         key: "iframe_custom_attribute",
//         inputtype: TextInput,
//       },
//       {
//         name: t("name"),
...
//       },
//       {
//         name: t("Allow Full Screen"),
//         key: "allowfullscreen",
//         col:12,
//         htmlAttr: "allowfullscreen",
//         inputtype: TextInput,
//       },
//       {
//         name: t("Allow Payment Request"),
//         key: "allowpaymentrequest",
//         col:12,
//         htmlAttr: "allowpaymentrequest",
//         inputtype: TextInput,
//       },
//       {
//         name: t("loading"),
...
//       },
//       {
//         name: t("Referrer Policy"),
//         key: "referrerpolicy",
//         col:12,
//         htmlAttr: "referrerpolicy",
//         inputtype: SelectInput,
//         data: {
//           options: [
//             { value: "", text: "None" },
//             { value: "no-referrer", text: "no-referrer" },
//             { value: "no-referrer-when-downgrade", text: "no-referrer-when-downgrade" },
//             { value: "origin", text: "origin" },
//             { value: "origin-when-cross-origin", text: "origin-when-cross-origin" },
//             { value: "same-origin", text: "same-origin" },
//             { value: "strict-origin", text: "strict-origin" },
//             { value: "strict-origin-when-cross-origin", text: "strict-origin-when-cross-origin" },
//             { value: "unsafe-url", text: "unsafe-url" },
//           ],
//         },
//       },
//       {
...
//           options: [
//             { value: "", text: "None" },
//             { value: "", text: "Applies all restrictions" },
//             { value: "allow-forms", text: "Allows form submission" },
//             { value: "allow-modals", text: "Allows to open modal windows" },
//             { value: "allow-orientation-lock", text: "Allows to lock the screen orientation" },
//             { value: "allow-pointer-lock", text: "Allows to use the Pointer Lock API" },
//             { value: "allow-popups", text: "Allows popups" },
//             { value: "allow-popups-to-escape-sandbox", text: "Allows popups to open new windows without inheriting the sandboxing" },
//             { value: "allow-presentation", text: "Allows to start a presentation session" },
//             { value: "allow-same-origin", text: "Allows the iframe content to be treated as being from the same origin" },
//             { value: "allow-scripts", text: "Allows to run scripts" },
//             { value: "allow-top-navigation", text: "Allows the iframe content to navigate its top-level browsing context" },
//             { value: "allow-top-navigation-by-user-activation", text: "Allows the iframe content to navigate its top-level browsing context, but only if initiated by user" },
//           ],
//         },
//       },
//     ]
