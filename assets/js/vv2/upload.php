...
$destination = UPLOAD_FOLDER . UPLOAD_PATH. str_ireplace(" ","_",$_FILES['file']['name']);
move_uploaded_file($_FILES['file']['tmp_name'], $destination);

if (isset($_POST['onlyFilename'])) {
	echo str_ireplace(" ","_",$_FILES['file']['name']);
} else {
	echo UPLOAD_PATH . str_ireplace(" ","_",$_FILES['file']['name']);
}
